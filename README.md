...
>
> 生活不会等你做完一件事再开始下一件事。电话来了，孩子叫你，一场会议开始了，一个新想法又冒出来。Atlas 不要求你记住一切——**它会替你记住：刚才做到哪里？下一步做什么？为什么值得继续？**
...
**Atlas 让你留在 Codex 对话里，直接说一句话。** 它把你明确想保留的灵感、决定和未完成事项记录下来。以后无论换到哪个任务，都可以问 Atlas：“我上次做到哪里了？”或者“今天最值得继续什么？”
...
所有新记录都会先进入待确认清单（Review Candidate），不会擅自执行，也不会保存整段聊天。当你想集中整理、搜索或管理这些记录时，再打开本地 Web Dashboard。
...
>
> Life rarely waits for you to finish one thing before starting another. The phone rings, your child needs you, a meeting begins, or a new idea appears. Atlas does not ask you to remember everything—**it remembers for you: Where did you stop? What should you do next? Why is it worth continuing?**
...
**Atlas lets you stay in the Codex conversation and simply say what should not be lost.** It records the ideas, decisions, and unfinished work you explicitly choose to keep. Later, from another task, ask “Where did I leave off?” or “What is worth continuing today?”
...
Every new item first enters a Review Candidate list. Atlas does not execute it or archive the entire conversation. Open the local Web Dashboard later when you want to review, search, or manage these records together.
