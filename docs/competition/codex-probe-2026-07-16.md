# Codex and Tracekeep MCP Probe — 2026-07-16

## Result

| Layer | Result | Evidence |
|---|---|---|
| Local Tracekeep Web | Passed | Existing service returned `ready`, SQLite integrity `ok`, schema v2 |
| Tracekeep skill fallback | Passed | The installed skill reached `http://127.0.0.1:4310/today` |
| MCP protocol | Passed | Stdio client listed all 11 tools against an isolated Tracekeep instance |
...
| Current Codex host exposure | Not available | No Tracekeep-named tool was exposed to this task session |
...
Tracekeep MCP remains **Experimental** for this release. The implementation and
...
installed Tracekeep skill providing direct links and a local HTTP fallback.
...
- No paid API, hosted Tracekeep service, or external write integration was enabled.
