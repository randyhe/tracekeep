...
Atlas uses layered unit, contract, integration, browser, security, and recovery testing. Real conversations remain local and never enter repository fixtures or CI artifacts.
