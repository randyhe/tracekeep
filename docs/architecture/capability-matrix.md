...
| ChatGPT Direct mobile | Not implemented | Requires ChatGPT App, stable HTTPS MCP gateway, OAuth 2.1, and outbound PC sync | Local Codex plugin and loopback Web | Future release; do not claim in v0.2.1 |
