...
import { inferSensitivity, isValuableTurn, parseCodexTurnTranscript } from "./stop-capture.mjs";
...
test("the Windows installer pins the MCP working directory at install time", async () => {
  const installer = await readFile(
    new URL("../../../packaging/windows/scripts/Install-Atlas.ps1", import.meta.url),
    "utf8",
  );
